        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    {!!Form::open(array("url"=>"/admin/add_student_process","method"=>"post","class"=>"form-horizontal","role"=>"form", "name"=>"add_student_form", "id"=>"add_student_form", "enctype"=>"multipart/form-data"))!!}

                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="district_operation">School Name</label>
                        <div class="col-sm-5">
                            {!!Form::text(NULL,session('myuser_schools')[2]['school_name'],array("class"=>"form-control", "disabled"))!!}
                            {!! Form::hidden('school_id',session("myuser_schools")[2]['school_id'],array("class"=>"form-control",'id'=>"school_id")) !!}
