					...
					<div class="page-content">
						...
						<div class="row">
	                            ...
	                            @endif
									...
									{!!Form::open(array("url"=>"admin/change_password_process","method"=>"post","class"=>"form-horizontal","role"=>"form", "name"=>"change_passowrd_form", "id"=>"change_passowrd_form",))!!}
	...
	$(document).on('keyup','#old_password',function(e){
           //alert(1);
            ...
            if(!old_password){
            	...
            	$.ajax({
	            url:'check_old_password_school_admin_function',
	            type:'POST',
