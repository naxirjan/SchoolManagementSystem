            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        {!! Form::open(array("url"=>"/admin/add_holiday_process",'id'=>'holiday_form',"method"=>"post","class"=>"form-horizontal","role"=>"form")) !!}
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-5" id="div-date-range">
                                  ...
                                  {!! Form::text("", session('myuser_schools')[2]['school_name'], array('id'=>'holiday_title', "class"=>"form-control","disabled"=>"true")) !!}


                                  <input type="hidden" name="admin_school_id" value="<?php echo session('myuser_schools')[2]['school_id']?>">
