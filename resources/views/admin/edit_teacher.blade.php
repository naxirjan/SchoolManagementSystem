		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					{!!Form::open(array("url"=>"/admin/edit_teacher_process","method"=>"post","class"=>"form-horizontal","role"=>"form", "name"=>"editTeacher_form", "id"=>"editTeacher_form", "enctype"=>"multipart/form-data"))!!}
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							{!!Form::text("email_address",$myusers['0']['email'],array("placeholder"=>"Enter Email Address","class"=>"form-control","id"=>"email_address"))!!}
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-4"></div>
                        <input type="hidden" name="id" value="{{$myusers['0']['id']}}">
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							{!! Form::textarea("address", $myusers['0']['address'], array("placeholder"=>"Enter Perment Address", 'id'=>'address', "class"=>"form-control", "rows"=>"2")) !!}
					...
					@if($myusers['0']['id']!=session('user_id'))
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							{!! Form::submit("Update Teacher", array("class"=>"btn btn-primary")) !!}
						</div>
					</div> 					
		 			{!!Form::close()!!}
				</div><!-- /.col -->
...
$(document).ready(function(event){
	...
	var user_validator = $("#editTeacher_form").validate({
		rules: {
			qualification: {
				required: true,
			},
