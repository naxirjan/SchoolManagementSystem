                            ...
                            <br />
                                ...
                                <span class="profile-picture" style="border-radius:50%;border:1px solid #e4e6e9;width:150px; height:150px;">
                                  @if($student->student_image !='student_icon.jpg')
                                    <img id="avatar" class="img-responsive" alt="No Image" src="{{asset('storage/schools/'.$students_image_path.'/'.$student->student_image)}}"
                                    width="140" height="140" style="border-radius:50%;width: 140px;height: 140px;">
                                @else
