...
@if(!empty($attendance))
          ...
          <div class="col-sm-10">
            ...
            <!--print button -->
            {!!Form::open(array("url"=>"/admin/get_report_monthly_individual","method"=>"post"))!!}
                    ...
                    <div id="tab-1" class="tab-pane active">
                        <div class="profile-user-info profile-user-info-striped">
                            ...
                            <div class="profile-info-row">
                             ...
                             <div class="profile-info-row">
                                <div class="profile-info-name" style="background-color: #0f8070;" > Total Student </div>
                                <div class="profile-info-value">
                                    <span class="dark" id="get_school_name">
                                          ...
                                          <div class="row">
                                            <div class="col-xs-12">
                                                  ...
                                                  <div class="profile-user-info profile-user-info-striped">
                                                      ...
                                                      <div class="profile-info-row">
                                                          <div class="profile-info-name"> Persant </div>
                                                       ...
                                                       <div class="profile-info-row">
                                                          <div class="profile-info-name"> Absant </div>
                                                          <div class="profile-info-value">
                                                              <span class="dark" id="get_school_name">
                                                          ...
                                                          <tr>
                                                                ...
                                                                <td>
                                                                   ...
                                                                   @if($value->student_individual_image !='student_icon.jpg')
                                                                    <img class="img-responsive" alt="No Image" src="{{asset($value->student_image)}}" width="50" height="50" style="border-radius:50%;">
