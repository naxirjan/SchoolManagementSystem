        ...
        <div class="page-content">
           ...
           <!--Alert If Class Students Promoted or Not-->
                ...
                <div class="col-xs-12">
                   ...
                   <div class="profile-user-info profile-user-info-striped">
                        ...
                        <select class="form-control" id="schools" style="color:#333333;font-weight:bold;font-size:13px;">
                            ...
                            @if($school->role_id==2)
                              <option get_school_name="{{$school->school}}" value="{{$school->school_id}}">{{$school->school}}</option>  
                            @endif
                            @endforeach 
                                </select> 
                                <input type="hidden" id="school_name" value="{{$school_information['school']}}" />
                            </div>
                        </div>
            ...
            <div class="alert alert-block alert-danger">
                            ...
                            <a style="text-decoration:none;" class="pull-right" href="javascript:history.back()"><i class="ace-icon fa fa-times"></i> &nbsp;</a> 

                <b> {{$school_information['school']}} &rArr; {{$class_information['class']}} Has No Students!...</b>
    ...
    /*Promote Class Students*/
        ...
        $(document).on('click','#btn-add',function() {
            ...
            $.each($("#current_class_students input[name='students']:checked"), function(){
               current_classes_students.push("<li data-order='"+$(this).attr('student_id')+"' id='student-row"+$(this).attr('student_id')+"'><label><input class='ace ace-checkbox-2'  student_name='"+$(this).attr('student_name')+"' student_id='"+$(this).attr('student_id')+"' type='checkbox' name='students' value='"+$(this).val()+"'/>"+"<span class='lbl'>&nbsp;<b>"+$(this).attr('student_name')+"</b></span></label></li>");
