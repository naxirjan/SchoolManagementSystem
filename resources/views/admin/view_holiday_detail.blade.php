                                ...
                                <div class="profile-user-info profile-user-info-striped">
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            ...
                                            <span class="editable editable-click red">
                                                Inactive
                                            </span>
                                            @endif
                                        </div>
                                    ...
                                    <?php if(!empty($assigend_holiday_of_assigned_school_admin)){?>
                                     <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable editable-click">
                                                        ...
                                                        foreach($assigend_holiday_of_assigned_school_admin as $schools)
                                                            { 
                                                                ?>
                                                                <?php echo $schools->school; ?> </br>
                                                                <?php
                                                             }
                                                        ?>
