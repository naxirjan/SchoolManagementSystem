            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        {!! Form::open(array("url"=>"/admin/update_holiday/","method"=>"post","class"=>"form-horizontal","role"=>"form","id"=>"edit_holiday_form")) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5" id="div-date-range">
                                ...
                                <input class="form-control" type="text" value="{{$holiday[0]['start_date'].' - '.$holiday[0]['end_date']}}" name="daterangepicker" id="id-date-range-picker-1" />
                                @if($errors->has("daterangepicker"))
                                <span class="badge badge-danger">Enter Holiday Date Range</span>
                                @endif
