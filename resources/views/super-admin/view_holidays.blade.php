                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-xs btn-info" href="/super_admin/edit_holiday/{{$holiday['id'] }}" title="Edit">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                    </a>
                                    | <a class="btn btn-xs btn-info" href="/super_admin/view_holiday_detail/{{$holiday['id'] }}" title="View Detail">
                                        <i class="ace-icon fa fa-eye bigger-130"></i>
                                    </a>
                                    | <a href="/super_admin/holiday_assign_school/{{$holiday['id'] }}" class="btn btn-xs btn-info"  title="Assign School">
