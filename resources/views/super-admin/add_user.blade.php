			...
			<div class="page-content">
				...
				<div class="row">
						<div class="col-xs-12">
								...
								@if(session('add_user_success_message'))
	                            <div class="alert alert-success">
									<button type="button" class="close" data-dismiss="alert">
										<i class="ace-icon fa fa-times"></i>
									</button>
									<b>{{session('add_user_success_message')}}</b>
								</div>
	                            @endif
	                            
	                            @if(session('add_user_fail_message'))
	                            <div class="alert alert-success">
									<button type="button" class="close" data-dismiss="alert">
										<i class="ace-icon fa fa-times"></i>
									</button>
									<b>{{session('add_user_fail_message')}}</b>
								</div>
								...
								{!!Form::open(array("url"=>"/super_admin/add_user_process","method"=>"post","class"=>"form-horizontal","role"=>"form","id"=>"addUserForm", "enctype"=>"multipart/form-data"))!!}
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										{!! Form::password("password", array("required", "placeholder"=>"Enter Password", "class"=>"form-control","id"=>"password")) !!}
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										{!! Form::password("conform_password", array("required", "placeholder"=>"Enter Confirm Password", "class"=>"form-control","id"=>"conform_password")) !!}
...
$(document).ready(function(event){
	...
	var UserValidator = $("#addUserForm").validate({
		rules: {
			qualification: {
				required: true
			},
		...
		messages: {
			...
			profile_image: {
				...
				accept: "profile picture must be .jpeg, .jpg, .png",
			},
		},
	});
});
