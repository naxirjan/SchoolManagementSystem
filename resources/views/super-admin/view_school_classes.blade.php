                                                ...
                                                <li>&nbsp;
                                                    ...
                                                    <p class="pull-right">
                                                        ...
                                                        <!--NOTE:
                                                            ...
                                                            $classes[2] = Class ID
                                                        -->
                                                        <a id="add_students_link" href="/super_admin/view_class_students/{{$classes[1]}}/{{$classes[2]}}" class_id='{{$classes[1]}}' style="text-decoration:none;" class="green ">
                                                        ...
                                                        <a id="add_students_link" href="/super_admin/add_students_to_school_class/{{$classes[1]}}/{{$classes[2]}}" class_id='{{$classes[1]}}' style="text-decoration:none;" class="blue ">
