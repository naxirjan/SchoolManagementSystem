...
{!! Form::open(array("url"=>"/super_admin/get_daily_attendance_report","method"=>"post","role"=>"form")) !!}
&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <img class="img-responsive" alt="No Image" src="{{asset($image_path.$all_student->student_image)}}" style="border-radius:50%;width: 50px;height: 50px;">
                                    @else
                                    <img id="avatar" class="img-responsive" alt="No Image" src="{{asset('storage/dumy_image/student_icon.jpg')}}" style="border-radius:50%;width: 50px;height: 50px;">
                                    @endif
