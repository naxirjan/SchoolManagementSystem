        ...
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    @if(session()->has('add_student_success_message'))
                    <div class="alert alert-success">
                        <button type="button" class="close" data-dismiss="alert">
                            <i class="ace-icon fa fa-times"></i>
                        </button>
                        <strong>
                            {{ session()->get('add_student_success_message') }}
                        </strong>
                        <br>
                    </div>
                    @endif
                    @if(session()->has('add_student_error_message'))
                    <div class="alert alert-danger">
                        <button type="button" class="close" data-dismiss="alert">
                            <i class="ace-icon fa fa-times"></i>
                        </button>
                        <strong>
                            {{ session()->get('add_student_error_message') }}
                        </strong>
                        <br>
                    </div>
                    @endif

                    {!!Form::open(array("url"=>"/super_admin/add_student_process","method"=>"post","class"=>"form-horizontal","role"=>"form", "name"=>"add_student_form", "id"=>"add_student_form", "enctype"=>"multipart/form-data"))!!}

                    <div class="form-group">

                        <?php
                        $all_schools =array(""=>"-- Select School --");
                        ...
                        <div class="col-sm-5">
                            {!! Form::select('school_id',$all_schools,old('school_id'),['id'=>"school_id","class"=>"form-control"]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!!Form::text("first_name",old('first_name'),array("placeholder"=>"Enter First Name","class"=>"form-control", "id"=>"first_name"))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!!Form::text("middle_name",old('middle_name'),array("placeholder"=>"Enter Middle Name","class"=>"form-control","id"=>"middle_name"))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!!Form::text("last_name",old('last_name'),array("placeholder"=>"Enter Last Name","class"=>"form-control","id"=>"last_name"))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!!Form::text("gaurdian_name",old('gaurdian_name'),array("placeholder"=>"Enter Guardian Name","class"=>"form-control", "id"=>"gaurdian_name"))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text("gaurdian_contact_number",old('gaurdian_contact_number'), array("placeholder"=>"Enter Guardian Contact Number", "class"=>"form-control","id"=>"contact_number")) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!!Form::date("date_of_brith",old('date_of_brith'),array("placeholder"=>"Enter Date Of Birth","class"=>"form-control", "id"=>"date_of_brith"))!!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="radio">
                                <label>
                                    {!! Form::radio("gender", "Male",(old('gender')=='Male'), array("class"=>"ace",'id'=>'male')) !!}
                                    <span class="lbl"> Male </span>
                                </label>
                                <label>
                                    {!! Form::radio("gender", "Female",(old('gender')=='Female'), array("class"=>"ace",'id'=>'female')) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5" id="div_address">
                            {!! Form::textarea("address",old('address'), array("placeholder"=>"Enter Address", 'id'=>'address', "class"=>"form-control", "rows"=>"2")) !!}
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="id-input-file-2" name="student_image" class="form-control">  
                            ...
                            @endif
                            <!-- <br />
                            <img id="std_image"  height="100px" width="100px"> -->
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            @if(old('student_status'))
                            <label class="control-label no-padding-right">
                                {!! Form::radio('student_status', '1',(old('student_status')=='1'),['class'=>'ace']); !!}
                                <span class="lbl">&nbsp;Active</span>
                            </label>
                            &nbsp;
                            &nbsp;
                            <label class="control-label no-padding-right">
                                {!! Form::radio('student_status', '0',(old('student_status')=='0'),['class'=>'ace']); !!}
                                <span class="lbl">&nbsp;Inactive</span>
                            </label>
                            @else
                            <label class="control-label no-padding-right">
                                {!! Form::radio('student_status', '1',true,['class'=>'ace']); !!}
                                <span class="lbl">&nbsp;Active</span>
                            </label>
                            &nbsp;
                            &nbsp;
                            <label class="control-label no-padding-right">
                                {!! Form::radio('student_status', '0',false,['class'=>'ace']); !!}
                                <span class="lbl">&nbsp;Inactive</span>
                            </label>
                            @endif
                        </div>
                ...
                @else
                    <div class="alert alert-danger">
                        ...
                        <strong>
                            No School Has Any Classes, Please Assign Classes To Schools First !...
                        </strong>
                        <br>
                    </div>
                  @endif
                ...
                <script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        //this code for if select box of school of error is emppty then not show of class select box otherwise show of selected school classes in new select box
                        ...
                        if(error_of_school == ""){
                            ...
                            url:"/get_classes",
                            type:"POST",
                            data:{_token: '{{csrf_token()}}',school_id:school_id},
...
<script>
    $(document).ready(function() {
        ValidationForm = $("#add_student_form").validate({
            rules:{
                school_id :{
                    required: true,
                },
