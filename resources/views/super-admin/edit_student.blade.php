        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    {!!Form::open(array("url"=>"/super_admin/edit_student_process","method"=>"post","class"=>"form-horizontal","role"=>"form", "name"=>"edit_student_form", "id"=>"edit_student_form", "enctype"=>"multipart/form-data"))!!}
