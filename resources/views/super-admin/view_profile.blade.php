									...
									<div id="user-profile-1" class="user-profile row" >
										...
										<div class="col-xs-12 col-sm-4 center">
                                            ...
                                            <div class="width-60 label label-warning label-xlg arrowed-in arrowed-in-right">
			                                    <div class="inline position-relative">
			                                        <a href="/super_admin/change_password" style="text-decoration: none;">
                                        ...
                                        <div class="col-sm-12 infobox-container">
                                            ...
                                            <div class="infobox infobox-green" style="width:250px;">
                                                ...
                                                <div class="infobox-data">
                                                    <span class="infobox-data-number" style="font-size: 18px; margin-top:10px"><b>{{ucwords($user->role_type)}}</b></span>
                                                </div>
                                            </div>    
                                            @else
                                                ...
                                                <div class="infobox-data">
                                                    <span class="infobox-data-number" style="font-size: 18px">{{ucwords($user->role_type)}}</span>
