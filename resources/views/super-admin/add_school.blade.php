        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    @endif
                    {!! Form::open(array("url"=>"/super_admin/add_school_process","id"=>"add_school_form","method"=>"post","class"=>"form-horizontal","role"=>"form")) !!}
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="district_operation">District Operation</label>
                        <div class="col-sm-5">
                            {!! Form::select('district_operation',$district_operations,old('district_operation'),['id'=>"district_operation","class"=>"form-control"]) !!}
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="school"><br />School Name</label>
                        <div class="col-sm-5">
                            <span class="badge badge-info">Note:School Name Like: House Of Knowledge (HOK-01)</span>
                            
                            {!! Form::text("school",old('school'), array("placeholder"=>"Enter School Name",'id'=>"school","class"=>"form-control")) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text("email",old('email'), array("placeholder"=>"Enter School Email",'id'=>"email","class"=>"form-control")) !!}
                            @if($errors->has("email"))
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::text("school_number",old('school_number'), array("placeholder"=>"Enter School Number",'id'=>"school_number","class"=>"form-control")) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::textarea("school_address",old('school_address'), array('id'=>'school_address',"placeholder"=>"Enter School Address","rows"=>2,"class"=>"form-control")) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            {!! Form::textarea("school_description",old('school_description'), array('id'=>'school_description',"placeholder"=>"Enter School Description","rows"=>10,"class"=>"form-control")) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            @if(old('school_status'))
                            <label class="control-label no-padding-right">
                                {!! Form::radio('school_status', '1',(old('school_status')=='1'),['class'=>'ace']); !!}
                                <span class="lbl">&nbsp;Active</span>
                            </label>
                            &nbsp;
                            &nbsp;
                            <label class="control-label no-padding-right">
                                {!! Form::radio('school_status', '0',(old('school_status')=='0'),['class'=>'ace']); !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! Form::submit("Add School", array("class"=>"btn btn-primary")) !!}
                        </div>
                    </div>
                    {!! Form::close() !!}
...
<script>
    $(document).ready(function() {
        //alert("working");
        userForm_1 = $("#add_school_form").validate({
            rules: {
                district_operation: {
                    required: true,
                },
