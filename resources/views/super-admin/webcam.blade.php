        ...
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div id="container">
                    ...
                    <div id="gui_controls">
                       <center><h1 style="border-bottom: 1px solid white;"><b>Action Controls</b></h1></center>
                        ...
                        <button id="toggleFullScreenButton" style="background-image:{{asset('../assets/web-cam/img/ic_fullscreen_white_48px.svg')}}" name="toggle FullScreen" type="button" aria-pressed="false"></button>

                        <center><h1 style="border-bottom: 1px solid white; margin-top:200px;"><b>Preview</b></h1></center>
