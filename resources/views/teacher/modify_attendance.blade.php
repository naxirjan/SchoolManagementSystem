                ...
                <div class="col-xs-12">
                                    ...
                                    <div class="profile-user-info profile-user-info-striped">
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="dark" id="get_school_name">
                                                    <b>{{session('myuser_schools')[3]['school_name']}}</b>
                                                </span>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                ...
                                                <select class="form-control" id="classes" style="color:#333333;font-weight:bold;font-size:13px;">
                                                    <option value="">-- Select Class --</option>
                                                    @foreach($teacher_classes as $teacher_class)
                                                    <option role_user_id="{{$teacher_class->sms_role_user_id}}" value="{{$teacher_class->sms_class_school_id}}">{{$teacher_class->class}}</option>
                                                    @endforeach
                                                </select>                                               
                                            </div>
                                        </div>
                                            ...
                                            <div class="profile-info-value">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control date-picker" id="attendance_date" type="text" data-date-format="d MM yyyy" placeholder="Enter attendance date" style="color:black;font-weight:bold;font-size:13px;">
                    ...
                    @else
                     <div class="alert alert-block alert-danger" >
                        ...
                        <span><b>{{session('myuser_schools')[3]['school_name']}} Has No Classes</b></span>
                    </div>
    ...
    <script>
        ...
        function disable_weekend_in_calender(weekend)
        {
          switch (weekend.toLowerCase()) {
           ...
           /*Hide All Alert Messages on onChange event of Class Selectbox*/
                ...
                /*Check If Validation Is Correct*/
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            role_user_id: $('#classes option:selected').attr("role_user_id"),
                        ...
                        success: function(data) {
                            ...
                            else if(data.message ==='attendance_is_added')
                            {
                                $("#alert-messages").addClass("alert-danger").show();
                                $("#message").html("<b>You Are Not Allowed To Modify Date: " + data.date + " Attendance !...");
                                $("#get_students_for_attendance").html("");
            ...
            $(document).on('submit','#my_form', function(event){
                      event.preventDefault();
                       ...
                       $.ajax({
                       url:"{{ route('teacher.submit_students_attendance') }}",
                       method:"POST",
