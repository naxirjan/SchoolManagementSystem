...
@if(!empty($daily_attendance_report))
    {!! Form::open(array("url"=>"/teacher/get_daily_attendance_report","method"=>"post","role"=>"form")) !!}
        &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"> 
                                                ...
                                                <img src="{{asset($image_path.$all_student->student_image)}}"  style="border-radius:50%;width: 50px;height: 50px;>
                                                @else
