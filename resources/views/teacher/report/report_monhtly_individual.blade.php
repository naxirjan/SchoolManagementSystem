<?php
        ...
        $report_month = str_replace(' ','_', date("F Y",strtotime($attendance['month_total_days'][0])));
        header("Content-Disposition: attachment; filename=Monthly_Individual_Report_$report_month.xls");
        header("Expires: 0");
  ...
  <tbody style="text-align:center;">
    <tr bgcolor="#f78952">
      <td colspan="7" bgcolor="#CD853F;">
            <h2 align="center"><b>{{date("F Y",strtotime($attendance['month_total_days'][0])) }}&nbsp;</b></h2>
      </td>
    </tr>
    <tr></tr>
</tbody>
...
<table>
    <tbody style="text-align:center;">
        ...
        <tr>
            <th bgcolor="#7c7c80" colspan="3" align="left" style="color:white"><b>Attendance Month</b></th>
            <td align="left"> {{ $attendance['month'] }}  </td>
        </tr>
