<div class="col-sm-12">
    <div class="row">
        ...
        <div class="col-sm-10">
        {!! Form::open(array("url"=>"/teacher/generate_excel_date_range_student_report","method"=>"post")) !!}
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div class="profile-user-info profile-user-info-striped">
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="dark">
                                        <b><?php if(!empty($total_working_days)){echo $total_working_days;}?></b>
                                    </span>                                            
                                </div>
                            </div>
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="dark">
                                        <b><?php if(!empty($total_present_days)){echo $total_present_days;}?></b>
                                    </span>                                            
                                </div>
                            </div>
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="dark">
                                        <b><?php if(!empty($total_absent_days)){echo $total_absent_days;}?></b>
                                    </span>                                            
                                </div>
                            </div>
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="dark">
                                        <b><?php if(!empty($total_weekends)){echo $total_weekends;} ?></b>
                                    </span>                                            
                                </div>
                            </div>
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="dark">
                                        <b><?php  if(!empty($total_holidays)){echo $total_holidays;}?></b>
                                    </span>                                            
                                </div>
                            </div>
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="dark">
                                        <b><?php  if(!empty($percentage)){echo $percentage;}?></b>
                                    </span>                                            
                                </div>
                            </div>
